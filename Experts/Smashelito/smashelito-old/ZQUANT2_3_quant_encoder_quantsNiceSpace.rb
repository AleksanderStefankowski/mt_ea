...
SUBSET_START = "// quantspaceNice_Start"
SUBSET_END   = "// quantspaceNice_End"
...
# tp = ["20"].uniq
# sl = ["20"].uniq
# tp = ["06", "08", "10", "12" ].uniq  # 14    # Possible TP values
# sl = ["06","04", "08", "10"].uniq # "08"  #   # Possible SL values
tp = ["24", "32", "40" ].uniq # "48"
sl = ["24", "16", "32", "40"].uniq

excluded_combinations_last_4_digits = ["1404", "1204", "1004", "4824", "4024", "4816"] # exclude the ones too extreme IMO
...
final_magics.each_with_index do |magic, i|
  ...
  block << "g_trade[#{idx}].bannedRanges             = \"21,20,23,59;0,0,1,0;15,25,15,35\";" # = \"22,0,23,59;0,0,1,0\";"
...
File.write("ZQUANT2_3_quant_encoder_quantsNiceSpace_output.txt", all_output.join("\n"))
...
puts "\n(full output saved to ZQUANT2_3_quant_encoder_quantsNiceSpace_output.txt)"