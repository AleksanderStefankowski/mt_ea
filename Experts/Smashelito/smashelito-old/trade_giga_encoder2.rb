...
Group 204: ["01", "07", "37", "43", "73", "74", "75", "76", "77", "78", "79", "80", "81", "82", "83", "84", "85", "86", "87", "88", "89", "90", "91", "92", "93", "94", "95", "96", "97", "98", "99"]
Group 214: ["01", "02", "03", "04", "05", "06", "07", "08", "09"]
TEXT
# Group 201: ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "12", "13", "14", "15", "16", "18", "19", "21", "31", "32", "41", "85", "86", "87"]
# Group 202: ["01", "02", "03", "04", "10", "11", "20", "30", "40", "50", "60", "61", "62", "70"]
# Group 203: ["01", "10", "20", "30"]
...
ENABLED    = true
TRADE_SIZE = 100
MAX_TRADES_PER_BATCH = 2600 # 4320 # excess combinations go to trade_giga_encoder2_output_part2, part3, ...; each part indexes g_trade from TRADE_INDEX_START again
...
# of  = ["03", "15"] 
of  = ["03", "10", "20", "35"] #  "10" usunąłem do gentest by przyspieszyć sim! na koniec potem znowu simnąć!!!!!!!           # shorts should be tight? let's see result
# of  = ["03", "05", "10", "15", "21", "30", "45"] #  dla 101 testy offset

bbb = "700"

tp  = ["06", "08", "10", "12"].uniq # ["06", "08", "12"] # ["06"] # najpierw przelecieć TP SL 6 różne offset, potem wytypować 2 best offset per magic (lub worst do reverse)
...
MAGIC_NUMBERS.each_slice(MAX_TRADES_PER_BATCH).with_index(1) do |batch, part_num|
  ...
  batch.each_with_index do |magic, i|
    ...
    block << 'g_trade[' + idx.to_s + '].bannedRanges = "21,15,23,59;0,0,1,0,15,25,15,35";' 
