...
bool Subset_10216(double levelPx, int levelIdx, int kLast)
{
   ...
   string diffAbove = Rules_GetHighestDiffFromLevelInWindowString(levelPx, kLast, streakAbove, true);
   if(StringToDouble(diffAbove) < 45.0) return false;
   return true;
}
...
bool Subset_10293(double levelPx, int levelIdx, int kLast)
{
   if(levelPx >= g_ONhighSoFarAtBar[kLast].value) return false;
...
bool Subset_10294(double levelPx, int levelIdx, int kLast)
{
   if(levelPx >= g_ONhighSoFarAtBar[kLast].value) return false;
...
bool Subset_10295(double levelPx, int levelIdx, int kLast)
{
   if(levelPx >= g_ONhighSoFarAtBar[kLast].value) return false;
...
bool Subset_10296(double levelPx, int levelIdx, int kLast)
{
   if(levelPx >= g_ONhighSoFarAtBar[kLast].value) return false;
...
bool PendingRuleSubsetPassesForFullMagic(const long fullMagic, const double levelPx, const int levelIdx, const int kLast)
{
   ...
   if(subsetHandlerKey == 10293 || subsetHandlerKey == 30293)
      return Subset_10293(levelPx, levelIdx, kLast);
   if(subsetHandlerKey == 10294 || subsetHandlerKey == 30294)
      return Subset_10294(levelPx, levelIdx, kLast);
   if(subsetHandlerKey == 10295 || subsetHandlerKey == 30295)
      return Subset_10295(levelPx, levelIdx, kLast);
   if(subsetHandlerKey == 10296 || subsetHandlerKey == 30296)
      return Subset_10296(levelPx, levelIdx, kLast);
