...
#define ALGO_FAMILY_REGISTRY_MAX  29
...
//algocreator2start
   ...
   g_algos[AlgoSlotIndexByAlgoId(MAGIC_ALGO23)].enabled                                         = true;
   ...
   g_algos[AlgoSlotIndexByAlgoId(MAGIC_ALGO26)].enabled                                         = true;
   ...
   g_algos[AlgoSlotIndexByAlgoId(MAGIC_ALGO27)].enabled                                         = true;
